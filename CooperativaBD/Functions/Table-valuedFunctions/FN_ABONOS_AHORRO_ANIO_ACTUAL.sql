...
/****** Object:  UserDefinedFunction [dbo].[FN_ABONOS_AHORRO_ANIO_ACTUAL]    Script Date: 22/09/2017 13:29:51 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE FUNCTION [dbo].[FN_ABONOS_AHORRO_ANIO_ACTUAL] 
(	
